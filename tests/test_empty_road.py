...
class EmptyRoadTests:
    ...
    def validate_empty_road_no_cars(self):
    ...
    def test_empty_road_no_cars(self, benchmark):
        benchmark(self.validate_empty_road_no_cars)
        
    def validate_empty_road_landscape(self):
    ...
    def test_empty_road_landscape(self, benchmark):
        benchmark(self.validate_empty_road_landscape)
